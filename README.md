...
> Есть еще версия в ветке alternative. Она использует form request. Но если запрос не соответсвует json формату она выдаст html страницу 404. Что не соответсвует требованиям задания. Не знаю какая лучше. 
